...
class FormModuleValidate implements InputFilterAwareInterface {
                        ...
                        'validators' => array(
                            array(
                                ...
                                'options' => array(
                                    ...
                                    'max' => 60,
                                    'messages' => array(
                                        \Zend\Validator\StringLength::TOO_SHORT => 'Nombre del módulo no permitido',
                                        \Zend\Validator\StringLength::TOO_LONG => 'Tamaño del nombre del módulo exagerado'
                                    )
                                )
                            ),
                            array(
                                ...
                                'options' => array(
                                    'messages' => array(
                                        \Zend\Validator\NotEmpty::IS_EMPTY => 'Nombre del módulo no puede ser vacio'
                                    )
                                )
                            ),
                            array(
                                ...
                                'options' => array(
                                    ...
                                    'messages' => array(
                                        \Zend\Validator\Regex::INVALID => 'Nombre del módulo no valido1',
                                        \Zend\Validator\Regex::NOT_MATCH => 'Nombre del módulo no valido'
                                    )
                                )
                            )
                        )
